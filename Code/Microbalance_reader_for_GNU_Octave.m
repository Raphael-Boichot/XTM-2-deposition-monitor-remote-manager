...
if protocol_failure==0 %microbalance detected
    ...
    if response(1)=='0'
        ...
        disp('Crystal_failure, program termination !')
        uiwait(msgbox('Crystal_failure, program termination !', 'Microbalance status'))
    end
    ...
    disp('No matching device found, check connection and baudrate')
    msgbox('No matching device found, check connection and baudrate', 'Microbalance status');
end
