...
- It set the main measurement parameters to user values: density, z-ratio and tooling factor (here for alumina for example, see INFICON reference manual);
...
The code contains all necessary comments to make a link with the INFICON reference manual.
